      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View>
          <Text style={styles.RegularText}>
            ...
            Conditions") carefully before using the www.clubpassports.com
            website and the Club Passport mobile application (together, or
            individually, the "Service") operated by MobileSoft LLC ("us", "we",
            or "our").
          </Text>
          <Text style={styles.RegularText}>
        ...
        <View>
          ...
          <Text style={styles.RegularText}>
            ...
            information, you automatically authorize MobileSoft LLC to charge
          ...
          <Text style={styles.RegularText}>
            Should automatic billing fail to occur for any reason, MobileSoft
        ...
        <View>
          <Text style={styles.HeaderText}>Trial</Text>
          <Text style={styles.RegularText}>
            MobileSoft LLC may, at its sole discretion, offer a Subscription
          ...
          <Text style={styles.RegularText}>
            ...
            Free Trial, you will not be charged by MobileSoft LLC until the Free
          ...
          <Text style={styles.RegularText}>
            At any time and without notice, MobileSoft LLC reserves the right to
            (i) modify the terms and conditions of the Free Trial offer, or (ii)
            cancel such Free Trial offer.
          </Text>
        </View>
        <View>
          <Text style={styles.HeaderText}>Fee Changes</Text>
          <Text style={styles.RegularText}>
            MobileSoft LLC, in its sole discretion and at any time, may modify
          ...
          <Text style={styles.RegularText}>
            MobileSoft LLC will provide you with a reasonable prior notice of
        ...
        <View>
          <Text style={styles.HeaderText}>Refunds</Text>
          <Text style={styles.RegularText}>
            Certain refund requests for Subscriptions may be considered by
            MobileSoft LLC on a case-by-case basis and granted in sole
            discretion of MobileSoft LLC.
          </Text>
        </View>
        <View>
          ...
          <Text style={styles.RegularText}>
            MobileSoft LLC has the right but not the obligation to monitor and
            edit all Content provided by users.
          </Text>
          <Text style={styles.RegularText}>
            In addition, Content found on or through this Service are the
            property of MobileSoft LLC or used with permission. You may not
        ...
        <View>
          ...
          <Text style={styles.RegularText}>
            ...
            property of MobileSoft LLC and its licensors. The Service is
            ...
            written consent of MobileSoft LLC.
          </Text>
        </View>
        <View>
          <Text style={styles.HeaderText}>Links To Other Web Sites</Text>
          <Text style={styles.RegularText}>
            Our Service may contain links to third party web sites or services
            that are not owned or controlled by MobileSoft LLC
          </Text>
          <Text style={styles.RegularText}>
            MobileSoft LLC has no control over, and assumes no responsibility
            for the content, privacy policies, or practices of any third party
            web sites or services. We do not warrant the offerings of any of
            these entities/individuals or their websites.
          </Text>
          <Text style={styles.RegularText}>
            You acknowledge and agree that MobileSoft LLC shall not be
        ...
        <View>
          ...
          <Text style={styles.RegularText}>
            You agree to defend, indemnify and hold harmless MobileSoft LLC and
        ...
        <View>
          ...
          <Text style={styles.RegularText}>
            In no event shall MobileSoft LLC, nor its directors, employees,
        ...
        <View>
          ...
          <Text style={styles.RegularText}>
            MobileSoft LLC its subsidiaries, affiliates, and its licensors do
        ...
        <View>
          <Text style={styles.HeaderText}>Exclusions</Text>
          <Text style={styles.RegularText}>
        ...
        <View>
          <Text style={styles.HeaderText}>Governing Law</Text>
          <Text style={styles.RegularText}>
            These Terms shall be governed and construed in accordance with the
            laws of Missouri, United States, without regard to its conflict of
            law provisions.
          </Text>
          <Text style={styles.RegularText}>
